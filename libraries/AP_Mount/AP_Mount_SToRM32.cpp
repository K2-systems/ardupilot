...
bool AP_Mount_SToRM32::handle_gimbal_manager_flags(uint32_t flags)
{
...
void AP_Mount_SToRM32::update_gimbal_device_flags()
{
...
void AP_Mount_SToRM32::send_target_angles()
{
...
void AP_Mount_SToRM32::update_target_angles()
{
...
void AP_Mount_SToRM32::determine_protocol(const mavlink_message_t &msg)
{
...
bool AP_Mount_SToRM32::has_roll_control() const
{
    if (_protocol == Protocol::GIMBAL_DEVICE) {
...
bool AP_Mount_SToRM32::has_pitch_control() const
{
    if (_protocol == Protocol::GIMBAL_DEVICE) {
...
bool AP_Mount_SToRM32::get_angular_velocity(Vector3f& rates)
{
    if (!_initialised) {
        return false;
    }
...
void AP_Mount_SToRM32::handle_gimbal_device_information(const mavlink_message_t &msg)
{
...
void AP_Mount_SToRM32::handle_gimbal_device_attitude_status(const mavlink_message_t &msg)
{
    if (_protocol != Protocol::GIMBAL_DEVICE) {
        return;
    }
...
void AP_Mount_SToRM32::handle_message_extra(const mavlink_message_t &msg)
{
...
void AP_Mount_SToRM32::send_cmd_request_gimbal_device_information()
{
...
void AP_Mount_SToRM32::send_cmd_do_mount_control()
{
    if (!HAVE_PAYLOAD_SPACE(_chan, COMMAND_LONG)) {
        return;
    }
...
void AP_Mount_SToRM32::send_gimbal_device_set_attitude()
{
...
void AP_Mount_SToRM32::send_autopilot_state_for_gimbal_device()
{
...
void AP_Mount_SToRM32::send_system_time()
{
...
void AP_Mount_SToRM32::send_rc_channels()
{
...
void AP_Mount_SToRM32::send_banner()
{
...
void AP_Mount_SToRM32::update_send_banner()
{
...
void AP_Mount_SToRM32::send_gimbal_manager_information(mavlink_channel_t chan)
{
...
uint8_t AP_Mount_SToRM32::get_gimbal_device_id() const
{
    if (_instance == 0) {
...
uint32_t AP_Mount_SToRM32::get_gimbal_manager_flags() const
{
...
bool AP_Mount_SToRM32::has_failures(char* s)
{
...
bool AP_Mount_SToRM32::is_healthy()
{
    if (_protocol == Protocol::GIMBAL_DEVICE) {
...
void AP_Mount_SToRM32::update_checks()
{
char txt[255];
...
// is called with 1 Hz
bool AP_Mount_SToRM32::healthy() const
{
...
void AP_Mount_SToRM32::update_manager_status()
{
...
bool AP_Mount_SToRM32::get_location_target(Location &_target_loc)
{
...
void AP_Mount_SToRM32::set_attitude_euler(float roll_deg, float pitch_deg, float yaw_bf_deg)
{
...
bool AP_Mount_SToRM32::take_control()
{
...
bool AP_Mount_SToRM32::give_control()
{
...
bool AP_Mount_SToRM32::take_picture()
{
...
bool AP_Mount_SToRM32::record_video(bool start_recording)
{
    if (_camera_mode == CameraMode::UNDEFINED) {
...
bool AP_Mount_SToRM32::cam_set_mode(bool video_mode)
{
...
// bool AP_Mount_SToRM32::cam_do_photo_video_mode(PhotoVideoMode photo_video_mode)
// {
...
void AP_Mount_SToRM32::send_cmd_do_digicam_configure(bool video_mode)
{
    if (!HAVE_PAYLOAD_SPACE(_chan, COMMAND_LONG)) {
        return;
    }
...
void AP_Mount_SToRM32::send_cmd_do_digicam_control(bool shoot)
{
    if (!HAVE_PAYLOAD_SPACE(_chan, COMMAND_LONG)) {
        return;
    }
...
void AP_Mount_SToRM32::send_gimbal_device_attitude_status(mavlink_channel_t chan)
{
    // space already checked by streamer
